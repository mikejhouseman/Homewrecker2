...
* Request
  ...
  * Body:
    ...
    ```json
    {
      "reviewText": "This was an awesome spot!",
      "stars": 5
    }
    ```
...
* Error Response: Body validation errors
  ...
  * Body:
    ...
    ```json
    {
      "message": "Bad Request", // (or "Validation error" if generated by Sequelize),
      "errors": {
        "reviewText": "Please provide a review between 2 and 500 characters.",
        "stars": "Please provide a star rating between 1 and 5."
      }
    }
    ```
...
* Error response: Review from the current user already exists for the Spot
  ...
  * Body:
    ...
    ```json
    {
      "message": "Review already exists for this spot"
    }
    ```
...
* Request
  * Method: DELETE
  * URL: /reviews/images/:reviewImageId
  * Body: none
